...
class AdWithOnlyText extends StatefulWidget {
  final AdLayoutType layoutType;
  final String? adWithColor;

  const AdWithOnlyText({super.key, this.adWithColor, required this.layoutType});

  @override
  State<AdWithOnlyText> createState() => _AdWithOnlyTextState();
}

class _AdWithOnlyTextState extends State<AdWithOnlyText> {
        ...
        child: Column(
          children: [
            DynamicAdWidget(
              ...
              adColorCode: widget.adWithColor,
  ...
  Color getAdBackgroundColor() {
    if (widget.adWithColor == null) {
      return Colors.white;
    }
    switch (widget.adWithColor) {
      case 'E3F300':
